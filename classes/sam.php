...
class SAM{
		...
		protected function write_hello($socket){
			$r="HELLO VERSION MIN=3.1 MAX=3.1\r\n";
		...
		protected function session_init($style='STREAM',$id='SAMCHECK'){
			...
			$this->swrite($this->session_socket,"SESSION CREATE STYLE=$style DESTINATION=TRANSIENT ID=".$this->idname." i2cp.leaseSetEncType=4,0\r\n");
